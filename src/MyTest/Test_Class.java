...
public class Test_Class {
    ...
    public void BMW1(){
        ...
        Assert.assertTrue("2655.15".equals(b1.lease_MonthlyCalculator()));

        Assert.assertTrue(true==(b1.is_aligable()));

        Assert.assertTrue("64723.60".equals(b1.Total_Calculator()));
    ...
    public void BMW2(){
        ...
        Assert.assertTrue("1211.37".equals(b1.lease_MonthlyCalculator()));

        Assert.assertTrue(false==(b1.is_aligable()));

        Assert.assertTrue("44609.32".equals(b1.Total_Calculator()));
    ...
    public void BMW3(){
        ...
        Assert.assertTrue("1104.33".equals(b1.lease_MonthlyCalculator()));

        Assert.assertTrue(true==(b1.is_aligable()));

        Assert.assertTrue("54007.84".equals(b1.Total_Calculator()));
    ...
    public void Toyota1(){
        ...
        Assert.assertTrue("1841.74".equals(b1.lease_MonthlyCalculator()));

        Assert.assertTrue(false==(b1.is_aligable()));

        Assert.assertTrue("89403.52".equals(b1.Total_Calculator()));
    ...
    public void Toyota2(){
        ...
        Assert.assertTrue("2736.25".equals(b1.lease_MonthlyCalculator()));
    ...
    public void Hyundai1(){
        ...
        Assert.assertTrue("1289.94".equals(b1.lease_MonthlyCalculator()));

        Assert.assertTrue(true==(b1.is_aligable()));

        Assert.assertTrue("62917.12".equals(b1.Total_Calculator()));
    ...
    public void Hyundai3(){
        ...
        Assert.assertTrue("938.95".equals(b1.lease_MonthlyCalculator()));
